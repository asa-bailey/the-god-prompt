...
| `2026-07-16_TEST_SUITE_original.md` | Original "Vigil Test Authority Document" | Presented X-thread conversations as adversarial validation of a running enforcement architecture (none was running), and carried a "verification" SHA-256 attributed to @grok that does not match the transcript file at any point in git history. Replaced by the evaluation plan at `/TEST_SUITE.md`. |
