...
archive_content = """# README ARCHIVE: Legacy Testing & Notes

Source: Initial Development Turn (April 2026)
Testing the "In Discernment" Phase
The following notes were established during the transition from V1.0.0 (The Law) to V1.0.1 (The Covenant). These are to be used as a forensic baseline for evaluating the performance of the Grace Protocols.
